...
#ifdef WINCE //WINCE,for pps special used
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
...
//#define MCD_STRERROR _strerror_s()//strerror(errno)
#define MCD_CLEN(p) 1
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
#else //NOWINCE,for pps special used
// Text type and function defines (compiler and build-option dependent)
// Define MARKUP_STDC to force standard C defines in Visual Studio
// 
...
#endif // WIN32#define MCD_SPRINTF sprintf
#define MCD_FOPEN fopen
#define MCD_STRERROR strerror(errno)
#define MCD_SPRINTF sprintf
#define MCD_CLEN(p) 1
...
#endif//WINCE,for pps special used
...
#ifdef WINCE//special for WINCE
	bool SavePos( MCD_CSTR szPosName="" );
	bool RestorePos( MCD_CSTR szPosName="" );
#else
	bool SavePos( MCD_CSTR szPosName="" );
	bool RestorePos( MCD_CSTR szPosName="" );
#endif//special for WINCE
